  ...
  return (
    <div>
      <section className="px-3 py-5  lg:py-10">
        ...
        <div className=" justify-center ml-6 mt-20">
        <p className="text-4xl font-bold md:text-5xl  text-center ">  Welcome to patient-centered expert-led care where you and your whole body are treated compassionately</p>
        <p className="mt-2 text-sm md:text-lg justify-center  text-center ">We customize your integrative care plan to help you reach your wellness goals. And if you choose to focus on obesity medicine and metabolic health, we can do that, too.</p>
